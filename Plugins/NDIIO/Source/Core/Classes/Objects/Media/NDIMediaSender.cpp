...
static FBufferRHIRef CreateColorVertexBuffer(const FIntPoint& FitFrameSize, const FIntPoint& DrawFrameSize, bool OutputAlpha)
{
...
static FBufferRHIRef CreateAlphaEvenVertexBuffer(const FIntPoint& FitFrameSize, const FIntPoint& DrawFrameSize, bool OutputAlpha)
{
	FRHIResourceCreateInfo CreateInfo(TEXT("VertexBufferRHI"));
	FBufferRHIRef VertexBufferRHI = RHICreateVertexBuffer(sizeof(FMediaElementVertex) * 4, BUF_Volatile, CreateInfo);
...
static FBufferRHIRef CreateAlphaOddVertexBuffer(const FIntPoint& FitFrameSize, const FIntPoint& DrawFrameSize, bool OutputAlpha)
{
	FRHIResourceCreateInfo CreateInfo(TEXT("VertexBufferRHI"));
	FBufferRHIRef VertexBufferRHI = RHICreateVertexBuffer(sizeof(FMediaElementVertex) * 4, BUF_Volatile, CreateInfo);
...
#if ENGINE_MAJOR_VERSION == 5
			FBufferRHIRef ColorVertexBuffer = CreateColorVertexBuffer(FrameSize, NewFrameSize, this->OutputAlpha);
			FBufferRHIRef AlphaEvenVertexBuffer = CreateAlphaEvenVertexBuffer(FrameSize, NewFrameSize, this->OutputAlpha);
			FBufferRHIRef AlphaOddVertexBuffer = CreateAlphaOddVertexBuffer(FrameSize, NewFrameSize, this->OutputAlpha);
#elif ENGINE_MAJOR_VERSION == 4
